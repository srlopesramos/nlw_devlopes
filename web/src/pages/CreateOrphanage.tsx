...
export default function CreateOrphanage() {
  ...
  function handleSelectImages(event: ChangeEvent<HTMLInputElement>) {
    ...
    setPreviewImages(selectedImagesPreviw);
      ...
      <main>
        <form onSubmit={handleSubimit} className="create-orphanage-form">
          <fieldset>
            ...
            >
              <TileLayer
                url={`https://api.mapbox.com/styles/v1/mapbox/light-v10/tiles/256/{z}/{x}/{y}@2x?access_token=${process.env.REACT_APP_MAP_KEY}`}
              />
